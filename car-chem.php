    ...
    <script defer>
     ...
     <title>Автомобильная химия — Aliance Production</title>
      ...
      <body>
        ...
        <section class="about">
          <div class="section-about bg-image-ag">
            <div class="container">
              <div class="seporator"></div>
              <h2 class="section-title title-about">Автомобильная химия</h2>
              <ul class="breadcrumb">
          ...
          <div class="container">
            ...
            <div class="section-contracts__content">
              ...
              <h2 class="section-title section-contracts--title">
                Контрактное производство автомобильной химии</h2>
                <p class="section-contracts--description">
        ...
        <section class="section section--autochem-prod">
          <div class="container">            
            <div class="autochem-prod__wrapper">
              <div class="seporator"></div>
        ...
        <section class="section section--autochem-types">
          <div class="container">
            <div class="seporator"></div>            
            <h2 class="section-title">Виды автохимии</h2>
            <p class="autochem-types--description">
            ...
            <ul class="types__wrapper">
              <li class="types__wrapper--item">Антискотч</li>
              <li class="types__wrapper--item">Многоцелевая смазка</li>
              <li class="types__wrapper--item">Жидкий ключ</li>
              <li class="types__wrapper--item">Высокотемпературная смазка</li>
              <li class="types__wrapper--item">Универсальный очиститель деталей</li>
              <li class="types__wrapper--item">Силиконовая смазка</li>
              <li class="types__wrapper--item">Цепная смазка</li>
              <li class="types__wrapper--item">Медная смазка</li>
              <li class="types__wrapper--item">Графитовая смазка</li>
              <li class="types__wrapper--item">Очиститель кондиционера пенный</li>
              <li class="types__wrapper--item">Очиститель тормозных дисков</li>
              <li class="types__wrapper--item">Очиститель битумных пятен</li>
              <li class="types__wrapper--item">Очиститель кондционера</li>
              <li class="types__wrapper--item">Очиститель дросельной заслонки</li>
              <li class="types__wrapper--item">Очиститель обивки</li>
              <li class="types__wrapper--item">Тефлоновая смазка</li>
              <li class="types__wrapper--item">Очиститель двигателя</li>
              <li class="types__wrapper--item">Универсальный очиститель</li>
              <li class="types__wrapper--item">Чернитель шин</li>
              <li class="types__wrapper--item">Чернитель шин + очистка</li>
            </ul>
          </div>
        </section>
